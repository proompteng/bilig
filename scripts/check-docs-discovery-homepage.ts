...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string): void {
  requireAllIncludes(
    ...
    [
      ...
      'Cross-sheet dashboard recalculation is the worst p95',
      'holdout. Browser UI rendering is not part of this benchmark.',
      'rendering is not part of this benchmark.',
      '<code>3.281x</code>',
      'cross-sheet-dashboard-recalc is slower at p95:',
