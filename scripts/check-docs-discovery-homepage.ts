...
export function requireHomepageDiscovery(index: string, siteCss: string): void {
  requireAllIncludes(
    ...
    [
      ...
      '<link rel="stylesheet" href="./assets/site.css?v=2026-05-14-7" />',
      ...
      '46 mean wins. One p95 miss.',
      'This is the current checked-in WorkPaper vs HyperFormula run.',
      'with the caveat kept beside the',
      'workpaper-vs-hyperformula.json',
      'current baseline',
      'mean latency',
      'pnpm workpaper:bench:competitive:check',
      '<strong>46/46</strong>',
      'Every comparable mean row is green in this artifact.',
      'does not make every workbook, p95 row, or UI path faster.',
      '<code>1.043x</code>',
      'One approximate-lookup duplicate row is slower at p95:',
