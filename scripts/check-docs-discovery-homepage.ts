...
export function requireHomepageDiscovery(index: string, siteCss: string): void {
  requireAllIncludes(
    ...
    [
      ...
      '<link rel="stylesheet" href="./assets/site.css?v=2026-05-13-29" />',
      ...
      'Fast on the checked-in suite. Test your own workbook.',
      'The benchmark is intentionally narrow: WorkPaper versus HyperFormula-style headless workloads.',
      'WorkPaper vs HyperFormula',
      'Current artifact',
      'pnpm workpaper:bench:competitive:check',
      '<strong>46/46</strong>',
      'WorkPaper is faster on mean latency for every comparable row in the current run.',
      'Browser grid speed, Excel compatibility, or every possible workbook.',
      'packages/benchmarks/baselines/<wbr />workpaper-vs-hyperformula.json',
      '<code>lookup-approximate-duplicates</code> is slower at p95: 1.043x.',
