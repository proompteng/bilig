...
export function requireHomepageDiscovery(index: string, siteCss: string, productCss: string): void {
  requireAllIncludes(
    ...
    [
      ...
      '<strong>45/57</strong>',
      '45 of 57 comparable mean-latency rows are faster in the checked file.',
      'Lookup without a column index is the worst p95',
      'rendering is not part of this benchmark.',
      '<code>2.132x</code>',
      'lookup-no-column-index is slower at p95:',
