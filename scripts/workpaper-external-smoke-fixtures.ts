...
export function writeXlsxImportScript(projectDir: string): void {
  writeFileSync(
    ...
    [
      ...
      'if (!translatedStructuredRefs || currencyLabel.tag !== ValueTag.String || headerPeriod.tag !== ValueTag.Number || firstPeriod.tag !== ValueTag.Number || secondPeriod.tag !== ValueTag.Number || totalValue.tag !== ValueTag.Number || heightFeet.tag !== ValueTag.Number || editedTotalValue.tag !== ValueTag.Number || roundTripTotalValue.tag !== ValueTag.Number) {',
      '  throw new Error(`Unexpected XLSX import values: ${JSON.stringify({ translatedStructuredRefs, currencyLabel, headerPeriod, firstPeriod, secondPeriod, totalValue, heightFeet, editedTotalValue, roundTripTotalValue })}`);',
      '}',
