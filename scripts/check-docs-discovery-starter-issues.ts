...
const currentStarterIssueNumbers = [
  ...
  328, 329, 330, 331, 332, 333, 334, 342, 348, 358, 359, 360, 361, 362, 363, 366, 367, 368, 369, 370, 371, 375, 376, 380,
] as const
...
const closedStarterIssueNumbers = [
  ...
  188, 189, 190, 191, 192, 276, 227, 247, 256, 315, 316, 317, 318, 319, 336, 341, 343, 344, 345, 346, 347, 354, 364, 374, 377,
] as const
