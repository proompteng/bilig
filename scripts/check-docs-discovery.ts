...
requireIncludes(starterIssues, '92 open `first-timers-only` issues.', 'docs/starter-issues.md')
requireIncludes(starterIssues, '92 issues are generally available for a new contributor to claim.', 'docs/starter-issues.md')
