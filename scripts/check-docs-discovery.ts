...
requireIncludes(index, '<link rel="stylesheet" href="./assets/site.css?v=2026-05-13-24" />', 'docs/index.html')
...
requireIncludes(index, '<strong>Run the benchmark from the repo.</strong>', 'docs/index.html')
...
requireIncludes(index, 'Speed claims are cheap. Run the benchmark.', 'docs/index.html')
requireIncludes(index, 'The current run is checked in: 46 of 46 comparable mean rows ahead of HyperFormula', 'docs/index.html')
requireIncludes(index, 'plus the p95 row where bilig loses.', 'docs/index.html')
requireIncludes(index, 'Comparable rows only, measured by mean latency.', 'docs/index.html')
...
requireIncludes(index, '<dd>46 / 46 ahead</dd>', 'docs/index.html')
requireIncludes(index, 'The JSON changes in review when the benchmark moves.', 'docs/index.html')
requireIncludes(index, 'p95 1.043x', 'docs/index.html')
requireIncludes(index, 'test locally before quoting the headline number.', 'docs/index.html')
requireIncludes(index, '<code>lookup-approximate-duplicates</code>', 'docs/index.html')
requireIncludes(index, 'Coverage and caveats', 'docs/index.html')
requireIncludes(index, 'Small TypeScript tasks', 'docs/index.html')
requireIncludes(index, 'Start from the job you need done.', 'docs/index.html')
requireIncludes(index, 'Each route points to a runnable TypeScript example', 'docs/index.html')
requireIncludes(index, 'Install from npm in a blank folder.', 'docs/index.html')
requireIncludes(index, 'Put a WorkPaper behind a Node endpoint.', 'docs/index.html')
requireIncludes(index, 'Expose workbook reads and writes as tools.', 'docs/index.html')
requireIncludes(index, 'Check the alternatives before switching.', 'docs/index.html')
requireIncludes(index, 'Read the Excel gaps before importing real workbooks.', 'docs/index.html')
requireIncludes(index, 'Take a small issue that improves the public examples.', 'docs/index.html')
requireIncludes(index, 'Open the page for the thing you are building.', 'docs/index.html')
requireIncludes(index, 'without reading a launch essay first.', 'docs/index.html')
requireIncludes(index, '<h3>Run</h3>', 'docs/index.html')
requireIncludes(index, '<h3>Build</h3>', 'docs/index.html')
requireIncludes(index, '<h3>Agents</h3>', 'docs/index.html')
requireIncludes(index, '<h3>Decide</h3>', 'docs/index.html')
...
requireNotIncludes(index, 'The benchmark command and JSON artifact are in the repo.', 'docs/index.html')
requireNotIncludes(index, 'The benchmark is checked in.', 'docs/index.html')
requireNotIncludes(index, 'The current artifact shows 46 of 46 comparable mean rows ahead of HyperFormula', 'docs/index.html')
requireNotIncludes(index, 'The speed claim is deliberately narrow', 'docs/index.html')
requireNotIncludes(index, 'Run it yourself.', 'docs/index.html')
requireNotIncludes(index, 'the slower p95 row named beside the result.', 'docs/index.html')
requireNotIncludes(index, 'Comparable benchmark rows only. Treat the number like a benchmark, not a slogan.', 'docs/index.html')
requireNotIncludes(index, 'Mean latency only. This is not a promise that every workbook, formula, or p95 row is faster.', 'docs/index.html')
requireNotIncludes(index, '<dd>46 / 46 comparable mean rows</dd>', 'docs/index.html')
requireNotIncludes(index, 'The checked-in JSON is the thing to inspect in review, not a screenshot of the number.', 'docs/index.html')
requireNotIncludes(index, 'The artifact lives in the repo so benchmark drift shows up in review.', 'docs/index.html')
requireNotIncludes(index, 'That slower row stays visible because it matters if your workload looks like it.', 'docs/index.html')
...
requireNotIncludes(index, 'Pick the closest starting point.', 'docs/index.html')
requireNotIncludes(index, 'Docs, examples, issues.', 'docs/index.html')
