...
- TypeScript and linting are intentionally strict (`strict`, `exactOptionalPropertyTypes`, `noUncheckedIndexedAccess`, exhaustive switch checks, no floating promises). Follow the existing type-safe patterns instead of weakening types or bypassing lint rules.
