...
claude mcp add-json bilig-workpaper '{
  "type": "stdio",
  "command": "npm",
  "args": ["exec", "--package", "@bilig/headless@0.32.3", "--", "bilig-workpaper-mcp", "--workpaper", "./pricing.workpaper.json", "--init-demo-workpaper", "--writable"],
  "env": {}
}' --scope project
```
...
```text
https://github.com/proompteng/bilig/releases/download/libraries-v0.32.3/bilig-workpaper.mcpb.sha256
```
