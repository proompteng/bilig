...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/headless@0.31.1", "--", "bilig-agent-challenge"]
}
```
...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/headless@0.31.1", "--", "bilig-mcp-challenge"]
}
```
...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/headless@0.31.1", "--", "bilig-formula-clinic", "./reduced.xlsx", "--cells", "Summary!B7,Inputs!B2"]
}
```
