...
checked by this page is `@bilig/headless@0.16.27`.
...
`69/100` on both mean and p95.

The miss is not hidden: `build-mixed-content` is slower at p95 by
`2.977x`. Browser grid rendering is not part of this benchmark.
