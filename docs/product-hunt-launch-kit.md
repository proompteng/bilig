...
73/94 comparable mean-latency rows are faster in the checked WorkPaper vs
...
- The public benchmark page documents the narrow `73/94` comparable mean-row
  claim and the slower structural-insert-columns-large p95 caveat.
