...
The overall directional mean-ratio geomean is `0.6367963961549464`, and the
overall directional p95-ratio geomean is `0.6531874112281288`. Ratios below
...
holdout is `lookup-approximate-sorted-large`, where the current
WorkPaper-to-HyperFormula p95 ratio is `2.6263072529213884`. The honest claim is
`76/100` mean wins plus an
