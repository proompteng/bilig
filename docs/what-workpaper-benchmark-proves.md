...
The overall directional mean-ratio geomean is `0.6160584220564532`, and the
overall directional p95-ratio geomean is `0.6259364086734684`. Ratios below
...
WorkPaper-to-HyperFormula p95 ratio is `1.7850460403731596`. The honest claim is
