...
The overall directional mean-ratio geomean is `0.7240066714283266`, and the
overall directional p95-ratio geomean is `0.7330720883107373`. Ratios below
...
p95 ratio is `6.4928649835338925`. The honest claim is `45/57` mean wins plus an
