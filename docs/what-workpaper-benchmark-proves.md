...
The overall directional mean-ratio geomean is `0.6483251784617534`, and the
overall directional p95-ratio geomean is `0.6586172990289921`. Ratios below
...
scorecard records `69/100` workloads winning both mean and p95. The worst p95
holdout is `build-mixed-content`, where the current
WorkPaper-to-HyperFormula p95 ratio is `2.9767210268354547`. The honest claim is
