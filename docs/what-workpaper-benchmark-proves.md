...
The overall directional mean-ratio geomean is `0.6336586169180994`, and the
overall directional p95-ratio geomean is `0.6740490944769602`. Ratios below
...
WorkPaper-to-HyperFormula p95 ratio is `5.425557986875876`. The honest claim is
