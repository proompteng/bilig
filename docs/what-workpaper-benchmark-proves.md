...
The overall directional mean-ratio geomean is `0.6061476464503875`, and the
overall directional p95-ratio geomean is `0.6035313818925182`. Ratios below
...
p95 ratio is `2.244433692967194`. The honest claim is `47/57` mean wins plus an
