...
- External open-source directory surface: the Open-Awesome submission for Bilig
  has a metadata refresh comment with the current `@bilig/headless@0.16.27`
...
- npm surface: `@bilig/headless@0.16.27`, with `12,568` downloads in the
...
- Do not route new evaluator traffic to the older public DEV copy until it is
  ...
  checked package evidence is `@bilig/headless@0.16.27`, `73/100` comparable
  mean wins, and `69/100` mean+p95 wins.
