...
- External open-source directory surface: the Open-Awesome submission for Bilig
  has a metadata refresh comment with the current `@bilig/headless@0.18.6`
...
- npm surface: `@bilig/headless@0.18.6`, with `12,568` downloads in the
...
- Do not route new evaluator traffic to the older public DEV copy until it is
  ...
  checked package evidence is `@bilig/headless@0.18.6`, `76/100` comparable
