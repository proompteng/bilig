...
```sh
npm exec --package @bilig/workpaper@0.40.3 -- bilig-agent-challenge
npm exec --package @bilig/workpaper@0.40.3 -- bilig-mcp-challenge
npm exec --package @bilig/workpaper@0.40.3 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable
npm exec --package @bilig/workpaper@0.40.3 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```

Claude Desktop users can install the released MCPB bundle from:

- https://github.com/proompteng/bilig/releases/download/libraries-v0.40.3/bilig-workpaper.mcpb
- https://github.com/proompteng/bilig/releases/download/libraries-v0.40.3/bilig-workpaper.mcpb.sha256
