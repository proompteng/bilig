...
```sh
npm exec --package @bilig/workpaper@0.40.19 -- bilig-agent-challenge
npm exec --package @bilig/workpaper@0.40.19 -- bilig-mcp-challenge
npm exec --package @bilig/workpaper@0.40.19 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable
npm exec --package @bilig/workpaper@0.40.19 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
