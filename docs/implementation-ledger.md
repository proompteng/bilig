...
| product shell supports rectangular drag selection | `packages/grid/src/SheetGridView.tsx`, `e2e/tests/web-shell.pw.ts` |
| product shell supports bilig-owned clipboard copy and paste shortcuts | `packages/grid/src/SheetGridView.tsx`, `e2e/tests/web-shell.pw.ts` |
