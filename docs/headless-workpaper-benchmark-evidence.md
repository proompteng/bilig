...
The overall directional mean-ratio geomean is `0.6423108464384375`. The overall
directional p95-ratio geomean is `0.6352924912161056`. Ratios below `1.0` mean
WorkPaper is faster for that metric.

The current worst mean row is `structural-append-formula-rows`, with a mean
ratio of `2.104497583069042`. The current worst p95 row is
`lookup-no-column-index`, with a p95 ratio of `2.132483183991975`. The
