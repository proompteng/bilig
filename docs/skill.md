...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/headless@0.25.4", "--", "bilig-agent-challenge"]
}
```
...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/headless@0.25.4", "--", "bilig-formula-clinic", "./reduced.xlsx", "--cells", "Summary!B7,Inputs!B2"]
}
```
