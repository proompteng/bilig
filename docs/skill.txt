...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/workpaper@0.40.35", "--", "bilig-agent-challenge"]
}
```
...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/workpaper@0.40.35", "--", "bilig-mcp-challenge"]
}
```
...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/workpaper@0.40.35", "--", "bilig-formula-clinic", "./reduced.xlsx", "--cells", "Summary!B7,Inputs!B2"]
}
```
