...
export default defineConfig({
  resolve: {
    alias: [
      { find: "@bilig/formula/program-arena", replacement: `${rootDir}packages/formula/src/program-arena.ts` },
      ...
      { find: "@bilig/binary-protocol", replacement: `${rootDir}packages/binary-protocol/src/index.ts` },
      { find: "@bilig/agent-api", replacement: `${rootDir}packages/agent-api/src/index.ts` },
      { find: "@bilig/storage-browser", replacement: `${rootDir}packages/storage-browser/src/index.ts` },
      { find: "@bilig/storage-server", replacement: `${rootDir}packages/storage-server/src/index.ts` },
      { find: "@bilig/wasm-kernel", replacement: `${rootDir}packages/wasm-kernel/src/index.ts` },
      { find: "@bilig/worker-transport", replacement: `${rootDir}packages/worker-transport/src/index.ts` },
