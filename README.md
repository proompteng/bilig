...
```sh
npm exec --package @bilig/headless@0.25.0 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
...
```sh
npm exec --package @bilig/headless@0.25.0 -- bilig-agent-challenge
```
...
`npm exec --package @bilig/headless@0.25.0 -- bilig-workpaper-mcp` when that is the
...
npm exec --package @bilig/headless@0.25.0 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable
