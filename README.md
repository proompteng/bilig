...
Need a custom workbook automation? See
[Custom Automation](docs/custom-automation.md) for small integrations such as
CSV/Excel validation, pricing calculators, payout models, report checks,
GitHub Actions, and agent/MCP tools.
...
For business-shaped example ideas, see
[`business starter issue drafts`](docs/business-starter-issue-drafts.md).
