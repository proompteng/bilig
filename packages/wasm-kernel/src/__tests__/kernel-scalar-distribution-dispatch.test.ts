  ...
  it("keeps scalar distribution and special-function dispatch stable across refactors", async () => {
    ...
    const packed = packPrograms([
      ...
      [
        ...
        encodePushNumber(1),
        encodePushNumber(2),
        encodeCall(BuiltinId.ConfidenceNorm, 3),
        encodeRet(),
      ],
      [
        encodePushNumber(0),
        encodePushNumber(1),
        encodePushNumber(2),
        encodeCall(BuiltinId.ConfidenceT, 3),
        encodeRet(),
      ],
      [
        encodePushNumber(0),
        encodePushNumber(1),
        encodePushNumber(2),
        encodeCall(BuiltinId.Standardize, 3),
        encodeRet(),
      ],
      [
        encodePushNumber(0),
      ...
      [
        ...
        encodePushNumber(1),
        encodePushNumber(2),
        encodeCall(BuiltinId.Norminv, 3),
        encodeRet(),
      ],
      ...
      [
        ...
        encodePushNumber(1),
        encodePushNumber(2),
        encodeCall(BuiltinId.GammaInv, 3),
        encodeRet(),
      ],
    ]);
