...
describe("wasm kernel statistics and special-function helpers", () => {
  ...
  it("keeps ranking and histogram helpers stable across refactors", async () => {
    ...
    kernel.uploadRangeMembers(
      Uint32Array.from([
        0, 1, 2, 3, 4, 5, 6, 7, 10, 11, 12, 13, 14, 15, 20, 21, 22, 23, 24, 25, 30, 31, 32, 33, 34,
        35, 40, 41, 42,
      ]),
    ...
    const packed = packPrograms([
      ...
      [
        encodePushRange(0),
        encodePushNumber(0),
        encodeCall(BuiltinId.PercentrankExc, 2),
        encodeRet(),
      ],
