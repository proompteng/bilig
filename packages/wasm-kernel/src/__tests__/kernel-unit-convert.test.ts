...
describe('wasm kernel convert helpers', () => {
  it('keeps unit conversion behavior stable across refactors', async () => {
    ...
    const packed = packPrograms([
      ...
      [encodePushNumber(0), encodePushString(2), encodePushString(3), encodeCall(BuiltinId.Convert, 3), encodeRet()],
      [encodePushNumber(0), encodePushString(4), encodePushString(5), encodeCall(BuiltinId.Convert, 3), encodeRet()],
      [encodePushNumber(0), encodePushString(6), encodePushString(7), encodeCall(BuiltinId.Convert, 3), encodeRet()],
      [encodePushNumber(0), encodePushString(8), encodePushString(9), encodeCall(BuiltinId.Convert, 3), encodeRet()],
    ])
