...
describe("wasm kernel ordered statistics dispatch slab", () => {
  it("keeps rank, percentiles, trimmean, and probability stable across refactors", async () => {
    ...
    kernel.uploadRangeMembers(
      Uint32Array.from([
        0, 1, 2, 3, 10, 11, 12, 13, 14, 15, 16, 17, 20, 21, 22, 23, 24, 25, 30, 31, 32, 40, 41, 42,
        50, 51, 52,
      ]),
    ...
    const packed = packPrograms([
      [
        ...
        encodePushRange(0),
        encodePushNumber(1),
        encodeCall(BuiltinId.RankAvg, 3),
        encodeRet(),
      ],
      ...
      [
        encodePushRange(1),
        encodePushNumber(0),
        encodeCall(BuiltinId.PercentileInc, 2),
        encodeRet(),
      ],
      ...
      [
        ...
        encodePushNumber(0),
        encodePushNumber(1),
        encodeCall(BuiltinId.PercentrankInc, 3),
        encodeRet(),
      ],
      [
        encodePushRange(4),
