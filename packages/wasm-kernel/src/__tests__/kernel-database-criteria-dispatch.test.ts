...
describe('wasm kernel database criteria dispatch', () => {
  it('keeps database builtins stable across refactors', async () => {
    ...
    const width = 32
    const strings = packStrings(['Tree', 'Height', 'Age', 'Yield', 'Profit', 'Apple', 'Pear', 'Cherry'])
    ...
    const packed = packPrograms([
      [encodePushRange(0), encodePushString(1), encodePushRange(1), encodeCall(BuiltinId.Dcount, 3), encodeRet()],
      [encodePushRange(0), encodePushString(0), encodePushRange(1), encodeCall(BuiltinId.Dcounta, 3), encodeRet()],
      [encodePushRange(0), encodePushRange(2), encodePushRange(1), encodeCall(BuiltinId.Dcount, 3), encodeRet()],
      [encodePushRange(0), encodePushString(2), encodePushRange(1), encodeCall(BuiltinId.Dget, 3), encodeRet()],
      [encodePushRange(0), encodePushString(3), encodePushRange(1), encodeCall(BuiltinId.Daverage, 3), encodeRet()],
      [encodePushRange(0), encodePushString(4), encodePushRange(1), encodeCall(BuiltinId.Dmax, 3), encodeRet()],
      [encodePushRange(0), encodePushNumber(0), encodePushRange(1), encodeCall(BuiltinId.Dmin, 3), encodeRet()],
      [encodePushRange(0), encodePushString(4), encodePushRange(1), encodeCall(BuiltinId.Dsum, 3), encodeRet()],
      [encodePushRange(0), encodePushString(2), encodePushRange(1), encodeCall(BuiltinId.Dproduct, 3), encodeRet()],
      [encodePushRange(0), encodePushString(1), encodePushRange(1), encodeCall(BuiltinId.Dstdev, 3), encodeRet()],
      [encodePushRange(0), encodePushString(1), encodePushRange(1), encodeCall(BuiltinId.Dstdevp, 3), encodeRet()],
      [encodePushRange(0), encodePushString(2), encodePushRange(1), encodeCall(BuiltinId.Dvar, 3), encodeRet()],
      [encodePushRange(0), encodePushString(2), encodePushRange(1), encodeCall(BuiltinId.Dvarp, 3), encodeRet()],
    ])
