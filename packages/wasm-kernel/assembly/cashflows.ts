...
export function presentValueCalc(
  rate: f64,
  periods: f64,
  payment: f64,
  future: f64,
...
export function periodicPaymentCalc(
  rate: f64,
  periods: f64,
  present: f64,
  future: f64,
...
export function totalPeriodsCalc(
  rate: f64,
  payment: f64,
  present: f64,
  future: f64,
...
export function interestPaymentCalc(
  rate: f64,
  period: f64,
  periods: f64,
  present: f64,
...
export function principalPaymentCalc(
  rate: f64,
  period: f64,
  periods: f64,
  present: f64,
