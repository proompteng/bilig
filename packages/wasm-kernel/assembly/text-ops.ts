...
export function substituteNthText(
  text: string,
  oldText: string,
  newText: string,
  instance: i32,
...
export function indexOfTextWithMode(
  text: string,
  delimiter: string,
  searchFrom: i32,
  matchMode: i32,
...
export function lastIndexOfTextWithMode(
  text: string,
  delimiter: string,
  searchFrom: i32,
  matchMode: i32,
...
export function splitTextByDelimiterWithMode(
  text: string,
  delimiter: string,
  matchMode: i32,
): Array<string> {
