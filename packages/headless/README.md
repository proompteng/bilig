...
```sh
npm exec --package @bilig/headless@0.40.21 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```

Handing a spreadsheet task to another coding agent?

```sh
npm exec --package @bilig/headless@0.40.21 -- bilig-agent-challenge
npm exec --package @bilig/headless@0.40.21 -- bilig-mcp-challenge
```
...
Current checked npm footprint for `@bilig/headless@0.40.21`:
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.40.21/bilig-workpaper.mcpb)).
- Choosing the stack:
