...
| Formula workbook state belongs in a service or agent tool     | `npm install bilig-workpaper` or `npm install @bilig/headless` | `npm exec --package @bilig/headless@0.38.1 -- bilig-agent-challenge` prints `verified: true`.                                                 |
...
```sh
npm exec --package @bilig/headless@0.38.1 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```

Handing a spreadsheet task to another coding agent?

```sh
npm exec --package @bilig/headless@0.38.1 -- bilig-agent-challenge
npm exec --package @bilig/headless@0.38.1 -- bilig-mcp-challenge
```
...
Current checked npm footprint for `@bilig/headless@0.38.1`:
...
```sh
npm exec --package @bilig/headless@0.38.1 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
npm exec --package @bilig/headless@0.38.1 -- bilig-workpaper-mcp
npm exec --package @bilig/headless@0.38.1 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable
...
<https://github.com/proompteng/bilig/releases/download/libraries-v0.38.1/bilig-workpaper.mcpb>.
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.38.1/bilig-workpaper.mcpb)).
- Choosing the stack:
