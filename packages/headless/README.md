...
```sh
npm exec --package @bilig/headless@0.40.3 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
...
npm exec --package @bilig/headless@0.40.3 -- bilig-mcp-challenge
```
...
Current checked npm footprint for `@bilig/headless@0.40.3`:

- Pack dry run: `633 kB` tarball, `3.87 MB` unpacked, `630` package entries.
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.40.3/bilig-workpaper.mcpb)).
- Choosing the stack:
