...
| ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `SheetJS formula result not updating` or stale `xlsx` results | `npm install xlsx-formula-recalc`                                                                                                                                  | `npx --package xlsx-formula-recalc sheetjs-recalc --demo --json` returns fresh readback. |
