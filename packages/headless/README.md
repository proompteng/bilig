...
```sh
npm exec --package @bilig/headless@0.29.0 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```

Handing a spreadsheet task to another coding agent?

```sh
npm exec --package @bilig/headless@0.29.0 -- bilig-agent-challenge
npm exec --package @bilig/headless@0.29.0 -- bilig-mcp-challenge
```
...
Current checked npm footprint for `@bilig/headless@0.29.0`:
...
npm exec --package @bilig/headless@0.29.0 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable
...
<https://github.com/proompteng/bilig/releases/download/libraries-v0.29.0/bilig-workpaper.mcpb>.
...
- Agent and MCP workflows:
  ...
  ([download](https://github.com/proompteng/bilig/releases/download/libraries-v0.29.0/bilig-workpaper.mcpb)).
- Choosing the stack:
