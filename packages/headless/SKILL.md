...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/headless@0.32.6", "--", "bilig-agent-challenge"]
}
```
...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/headless@0.32.6", "--", "bilig-mcp-challenge"]
}
```
...
{
  "command": "npm",
  "args": ["exec", "--package", "@bilig/headless@0.32.6", "--", "bilig-formula-clinic", "./reduced.xlsx", "--cells", "Summary!B7,Inputs!B2"]
}
```
