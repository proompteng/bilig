...
For MCP, start with:
npm exec --package bilig-workpaper@0.34.0 -- bilig-mcp-challenge
npm exec --package bilig-workpaper@0.34.0 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable
...
```sh
npm exec --package bilig-workpaper@0.34.0 -- bilig-agent-challenge
npm exec --package bilig-workpaper@0.34.0 -- bilig-mcp-challenge
```
