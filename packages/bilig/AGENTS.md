...
For MCP, start with:
npm exec --package bilig-workpaper@0.37.0 -- bilig-mcp-challenge
npm exec --package bilig-workpaper@0.37.0 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable
...
- https://github.com/proompteng/bilig/releases/download/libraries-v0.37.0/bilig-workpaper.mcpb.sha256
...
```sh
npm exec --package bilig-workpaper@0.37.0 -- bilig-agent-challenge
npm exec --package bilig-workpaper@0.37.0 -- bilig-mcp-challenge
```
