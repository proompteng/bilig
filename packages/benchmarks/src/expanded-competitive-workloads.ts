...
export const EXPANDED_COMPARATIVE_WORKLOAD_SCORECARD_LANE = {
  ...
  'build-dense-literals-tall': 'public',
  ...
  'build-many-sheets-narrow': 'public',
  ...
  'batch-edit-multi-column-small': 'public',
  ...
  'structural-delete-columns-large': 'public',
  'structural-move-columns': 'public',
  'structural-move-columns-large': 'public',
  'range-read': 'public',
  ...
  'lookup-text-exact-large': 'public',
