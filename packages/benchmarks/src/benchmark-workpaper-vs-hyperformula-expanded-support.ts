...
export function normalizeWorkPaperValue(
  value: unknown,
...
export function normalizeHyperFormulaValue(
  value: unknown,
): boolean | number | string | null | { error: unknown } {
  if (
    value === null ||
...
export function toHyperFormulaSheet(
  sheet: ReadonlyArray<ReadonlyArray<unknown>>,
): HyperFormulaSheet {
