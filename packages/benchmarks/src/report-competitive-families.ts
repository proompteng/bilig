...
export const EXPANDED_COMPARATIVE_FAMILY_GROUPS = {
  ...
  'structural-rows': ['structural-insert-rows', 'structural-append-formula-rows', 'structural-delete-rows', 'structural-move-rows'],
  'structural-columns': ['structural-insert-columns', 'structural-delete-columns', 'structural-move-columns'],
  'range-read': ['range-read', 'range-read-dense', 'range-read-sparse-wide', 'range-read-formula-grid'],
