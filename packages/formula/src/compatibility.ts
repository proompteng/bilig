...
export const top50CompatibilityRegistry: readonly FormulaCompatibilityEntry[] = [
  ...
  entry("date-time:date-empty-year-coercion", "date-time", "=DATE(A1,1,1)", "implemented-js"),
  entry("date-time:date-text-error", "date-time", "=DATE(A1,1,1)", "implemented-js"),
  entry("date-time:year-boolean-coercion", "date-time", "=YEAR(A1)", "implemented-js"),
  entry("date-time:month-text-error", "date-time", "=MONTH(A1)", "implemented-js"),
  entry("date-time:day-leap-bug-serial", "date-time", "=DAY(A1)", "implemented-js"),
  entry("date-time:edate-boolean-coercion", "date-time", "=EDATE(A1,1)", "implemented-js"),
  entry("date-time:edate-text-error", "date-time", "=EDATE(A1,1)", "implemented-js"),
  entry("date-time:eomonth-boolean-coercion", "date-time", "=EOMONTH(A1,1)", "implemented-js"),
  entry("date-time:eomonth-text-error", "date-time", "=EOMONTH(A1,A2)", "implemented-js"),
