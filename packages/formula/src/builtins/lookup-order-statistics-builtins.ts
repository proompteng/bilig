...
function percentileFromValues(
  ...
  return interpolated === undefined
    ...
    : deps.numberResult(interpolated);
}
...
function percentRankFromValues(
  ...
  return rank === undefined
    ? deps.errorValue(ErrorCode.NA)
    : deps.numberResult(truncateToSignificance(rank, significance));
}
...
export function createLookupOrderStatisticsBuiltins(
  deps: LookupOrderStatisticsBuiltinDeps,
  ...
  return {
    ...
    PERCENTILE: (arrayArg, percentileArg) =>
      percentileFromValues(arrayArg, percentileArg, false, deps),
    "PERCENTILE.INC": (arrayArg, percentileArg) =>
      percentileFromValues(arrayArg, percentileArg, false, deps),
    "PERCENTILE.EXC": (arrayArg, percentileArg) =>
      percentileFromValues(arrayArg, percentileArg, true, deps),
    ...
    "PERCENTRANK.INC": (
      arrayArg,
      targetArg,
      significanceArg = { tag: ValueTag.Number, value: 3 },
    ) => percentRankFromValues(arrayArg, targetArg, significanceArg, false, deps),
    "PERCENTRANK.EXC": (
      arrayArg,
      targetArg,
    ...
    PROB: (xArg, probabilitiesArg, lowerArg, upperArg) =>
      probFromValues(xArg, probabilitiesArg, lowerArg, upperArg, deps),
