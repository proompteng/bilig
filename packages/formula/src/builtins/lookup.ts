...
function isError(value: LookupBuiltinArgument | undefined): value is Extract<CellValue, { tag: ValueTag.Error }> {
...
function collectNumericSeries(arg: LookupBuiltinArgument, mode: 'lenient' | 'strict'): number[] | CellValue {
  const values: number[] = []
