...
```sh
npm exec --package @bilig/workpaper@0.40.31 -- bilig-agent-challenge
npm exec --package @bilig/workpaper@0.40.31 -- bilig-mcp-challenge
npm exec --package @bilig/workpaper@0.40.31 -- bilig-workpaper-mcp --workpaper ./pricing.workpaper.json --init-demo-workpaper --writable
npm exec --package @bilig/workpaper@0.40.31 -- bilig-formula-clinic ./reduced.xlsx --cells "Summary!B7,Inputs!B2"
```
...
- https://github.com/proompteng/bilig/releases/download/libraries-v0.40.31/bilig-workpaper.mcpb.sha256
