...
export function FormulaAutocomplete({ suggestions, highlightedIndex, onSelect }: FormulaAutocompleteProps) {
            ...
            >
              <div className="flex items-center justify-between gap-3">
                <div className="min-w-0">
                  <div className="truncate text-[12px] font-semibold text-[var(--color-mauve-950)]">{suggestion.name}</div>
