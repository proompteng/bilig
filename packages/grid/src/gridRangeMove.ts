...
export function isSelectionMoveHandleHit(
  ...
  return (
    resolveSelectionMoveAnchorCell(clientX, clientY, sourceRange, getCellBounds, threshold) !== null
  );
}

export function resolveMovedRange(
  sourceRange: Rectangle,
  pointerCell: Item,
  anchorOffset: Item,
): Rectangle {
...
export function sameRectangle(
  left: Rectangle | null | undefined,
  right: Rectangle | null | undefined,
): boolean {
  return (
    left === right ||
    (left !== null &&
