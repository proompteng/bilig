...
describe("gridMetrics", () => {
  ...
  test("resolves visible column bounds and pointer columns with overrides", () => {
    ...
    expect(resolveColumnAtClientX(46 + PRODUCT_COLUMN_WIDTH + 30, { x: 0, width: 4 }, 46, 16384, columnWidths, PRODUCT_COLUMN_WIDTH)).toBe(1);
    expect(resolveColumnAtClientX(46 + PRODUCT_COLUMN_WIDTH + 140 + 10, { x: 0, width: 4 }, 46, 16384, columnWidths, PRODUCT_COLUMN_WIDTH)).toBe(2);
