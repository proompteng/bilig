...
export const excelTop50StarterFixtures: ExcelFixtureCase[] = [
  ...
  fixture("math", "round-basic", "ROUND", "=ROUND(A1,1)", [input("A1", 3.141)], [output("A2", numberExpected(3.1))]),
  ...
  fixture("date-time", "date-constructor", "DATE constructor", "=DATE(2026,3,15)", [], [output("A1", numberExpected(46096))], "Seeded until DATE parity is verified against committed goldens."),
