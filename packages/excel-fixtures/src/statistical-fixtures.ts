...
export const canonicalStatisticalFixtures: readonly ExcelFixtureCase[] = [
  ...
  fixture(
    "loginv-basic",
    "LOGINV exponentiates the inverse normal quantile",
    "=LOGINV(0.5,0,1)",
    [],
    [output("C1", numberExpected(1))],
  ),
  ...
  fixture(
    "correl-basic",
    "CORREL returns perfect linear correlation",
    "=CORREL(A1:A3,B1:B3)",
    regressionInputs(),
    [output("C1", numberExpected(1))],
  ),
  fixture(
    "covar-basic",
    "COVAR returns population covariance for paired ranges",
    "=COVAR(A1:A3,B1:B3)",
    regressionInputs(),
  ...
  fixture(
    "covariance-p-basic",
    "COVARIANCE.P returns population covariance",
  ...
  fixture(
    "covariance-s-basic",
    "COVARIANCE.S returns sample covariance",
  ...
  fixture(
    "pearson-basic",
    "PEARSON returns perfect linear correlation",
    "=PEARSON(A1:A3,B1:B3)",
    regressionInputs(),
    [output("C1", numberExpected(1))],
  ),
  fixture(
    "intercept-basic",
    "INTERCEPT returns the fitted regression intercept",
  ...
  fixture(
    "slope-basic",
    "SLOPE returns the fitted regression slope",
    "=SLOPE(A1:A3,B1:B3)",
    regressionInputs(),
    [output("C1", numberExpected(3))],
  ),
  fixture(
    "rsq-basic",
    "RSQ squares the paired correlation coefficient",
    "=RSQ(A1:A3,B1:B3)",
    regressionInputs(),
    [output("C1", numberExpected(1))],
  ),
  fixture(
    "steyx-basic",
    "STEYX returns zero for an exact linear fit",
    "=STEYX(A1:A3,B1:B3)",
    regressionInputs(),
    [output("C1", numberExpected(0))],
  ),
  ...
  fixture(
    ...
    [
      output("C1", numberExpected(1)),
      output("C2", numberExpected(2)),
      output("C3", numberExpected(3)),
      output("C4", numberExpected(0)),
    ],
  ),
  fixture(
    "t-dist-basic",
  ...
  fixture(
    "t-inv-2t-basic",
    "T.INV.2T returns the symmetric Student-t cutoff",
    "=T.INV.2T(0.5,1)",
    [],
    [output("C1", numberExpected(1))],
  ),
  ...
  fixture(
    "forecast-basic",
    "FORECAST projects a new y value from paired samples",
  ...
  fixture(
    "dget-basic",
    "DGET extracts a single matching database field value",
  ...
  fixture(
    "dsum-basic",
    "DSUM sums numeric field values from matching rows",
