...
export function isWorkbookAgentProtectionCommandKind(
  kind: string,
): kind is WorkbookAgentProtectionCommand["kind"] {
  return (
    kind === "setSheetProtection" ||
    kind === "clearSheetProtection" ||
    kind === "upsertRangeProtection" ||
...
export function isWorkbookAgentProtectionCommand(
  command: WorkbookAgentCommand,
): command is WorkbookAgentProtectionCommand {
  return isWorkbookAgentProtectionCommandKind(command.kind);
}

export function isWorkbookAgentProtectionCommandValue(
  value: unknown,
): value is WorkbookAgentProtectionCommand {
...
export function isHighRiskWorkbookAgentProtectionCommand(
  command: WorkbookAgentProtectionCommand,
): boolean {
...
export function describeWorkbookAgentProtectionCommand(
  command: WorkbookAgentProtectionCommand,
): string {
  switch (command.kind) {
    case "setSheetProtection":
...
export function estimateWorkbookAgentProtectionCommandAffectedCells(
  command: WorkbookAgentProtectionCommand,
): number {
  switch (command.kind) {
    case "setSheetProtection":
...
export function deriveWorkbookAgentProtectionCommandPreviewRanges(
  command: WorkbookAgentProtectionCommand,
...
export function applyWorkbookAgentProtectionCommand(
