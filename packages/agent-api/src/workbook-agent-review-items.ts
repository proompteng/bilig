...
export function toWorkbookAgentCommandBundle(
  reviewItem: WorkbookAgentReviewQueueItem,
): WorkbookAgentCommandBundle {
  return {
    id: reviewItem.id,
...
export function isWorkbookAgentReviewQueueItem(
  value: unknown,
): value is WorkbookAgentReviewQueueItem {
  return (
    isRecord(value) &&
