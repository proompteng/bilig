...
describe('renderer root', () => {
    ...
    await root.render(
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Sheet, { name: 'Sheet2' }, React.createElement(Cell, { addr: 'A1', value: 'ready' })),
        ),
      ),
    )
  ...
  it('rejects invalid workbook DSL trees before mutating engine state', async () => {
    ...
    await expect(root.render(React.createElement(Sheet, { name: 'Sheet1' }))).rejects.toThrow('Root descriptor must be a Workbook.')
    await expect(
      root.render(React.createElement(Workbook, { name: 'Book' }, React.createElement(Sheet, { name: 'Sheet1' }, 'bad text child'))),
    ...
    await expect(
      root.render(
        React.createElement(
          Workbook,
          { name: 'Book' },
          React.createElement(Sheet, { name: 'Sheet1' }, React.createElement(Cell, { addr: 'A1', value: 1, formula: 'B1' })),
        ),
      ),
    ...
    await expect(
      root.render(
        React.createElement(
          Workbook,
          { name: 'Book' },
          React.createElement(Sheet, { name: 'Sheet1' }, React.createElement(Sheet, { name: 'Nested' })),
        ),
      ),
    ...
    await expect(
      root.render(
        React.createElement(Workbook, { name: 'Book' }, React.createElement(React.StrictMode, null, React.createElement(Sheet, null))),
      ),
    ...
    await root.render(
      React.createElement(
        ...
        React.createElement(
          React.StrictMode,
          null,
          React.createElement(Sheet, { name: 'Sheet1' }, React.createElement(Cell, { addr: 'A1', value: 4 })),
        ),
      ),
    )
  ...
  it('normalizes wrapper-only and multi-workbook roots deterministically', async () => {
    ...
    await root.render(
      React.createElement(
        React.StrictMode,
        null,
        React.createElement(Workbook, { name: 'Book' }, React.createElement(Sheet, { name: 'Sheet1' })),
        React.createElement(Workbook, { name: 'Book' }, React.createElement(Sheet, { name: 'Sheet2' })),
      ),
    )
