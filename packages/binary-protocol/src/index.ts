...
import type { EngineOp, EngineOpBatch, WorkbookSortDirection, WorkbookSortKey, WorkbookTableOp } from '@bilig/workbook-domain'
...
function encodeDefinedNameValue(writer: BinaryWriter, value: WorkbookDefinedNameValueSnapshot): void {
...
function encodeDataValidation(writer: BinaryWriter, validation: WorkbookDataValidationSnapshot): void {
...
function encodeConditionalFormat(writer: BinaryWriter, format: WorkbookConditionalFormatSnapshot): void {
  writer.string(format.id)
...
function encodeSheetProtection(writer: BinaryWriter, protection: WorkbookSheetProtectionSnapshot): void {
...
function encodeRangeProtection(writer: BinaryWriter, protection: WorkbookRangeProtectionSnapshot): void {
