...
import { type EngineReplicaSnapshot, SpreadsheetEngine, type SpreadsheetEngineOptions } from './engine.js'
 ...
 */
export function isPersistedSpreadsheetEngineDocument(value: unknown): value is PersistedSpreadsheetEngineDocument {
  return (
    isRecord(value) &&
...
function assertPersistedSpreadsheetEngineDocument(value: unknown): asserts value is PersistedSpreadsheetEngineDocument {
 ...
 */
export function serializeSpreadsheetEngineDocument(document: PersistedSpreadsheetEngineDocument): string {
  assertPersistedSpreadsheetEngineDocument(document)
