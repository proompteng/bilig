...
export function normalizeCellStyleRecord(style: CellStyleRecord): WorkbookCellStyleRecord {
  ...
  const fontSize =
    typeof style.font?.size === 'number' && Number.isFinite(style.font.size) ? Math.max(1, Math.min(144, style.font.size)) : undefined
  if (
    fontFamily ||
    fontColor ||
    fontSize !== undefined ||
...
export function normalizeCellNumberFormatRecord(format: CellNumberFormatRecord): WorkbookCellNumberFormatRecord {
...
function normalizeHorizontalAlignment(value: CellHorizontalAlignment | undefined): CellHorizontalAlignment | undefined {
  switch (value) {
    case undefined:
      return undefined
    case 'general':
...
function normalizeVerticalAlignment(value: CellVerticalAlignment | undefined): CellVerticalAlignment | undefined {
  switch (value) {
    case undefined:
      return undefined
    case 'top':
...
function normalizeBorderWeight(value: CellBorderSideSnapshot['weight'] | undefined): CellBorderSideSnapshot['weight'] | undefined {
  switch (value) {
    case undefined:
      return undefined
    case 'thin':
...
function normalizeBorderSide(side: CellBorderSideSnapshot | undefined): CellBorderSideSnapshot | undefined {
  if (!side) {
    return undefined
  }
...
function normalizeBorders(style: CellStyleRecord['borders']): CellStyleRecord['borders'] | undefined {
  if (!style) {
    return undefined
  }
