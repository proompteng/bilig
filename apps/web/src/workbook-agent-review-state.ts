import { isWorkbookAgentReviewQueueItem, type WorkbookAgentReviewQueueItem } from '@bilig/agent-api'

export function decodeWorkbookAgentReviewItems(reviewQueueItems: unknown): WorkbookAgentReviewQueueItem[] {
