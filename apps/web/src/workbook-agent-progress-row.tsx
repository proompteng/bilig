...
import { workbookInsetClass, workbookStatusDotClass, workbookSurfaceClass } from './workbook-shell-chrome.js'
...
function ThinkingWave() {
  return (
    <span aria-label="Thinking" className="inline-flex items-center gap-[1px] text-[11px] font-medium text-[var(--wb-text-muted)]">
...
export function WorkbookAgentProgressRow() {
  ...
  useEffect(() => {
    const interval = window.setInterval(() => {
      setStageIndex((currentIndex) => (currentIndex < progressStages.length - 1 ? currentIndex + 1 : currentIndex))
  ...
  return (
    <div className="px-1 py-1.5">
      ...
      >
        ...
        <div aria-hidden="true" className={cn(workbookInsetClass(), 'mt-2 grid grid-cols-3 gap-1 overflow-hidden p-1')}>
