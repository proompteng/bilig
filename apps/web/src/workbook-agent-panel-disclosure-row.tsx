      ...
      <div className={agentPanelDisclosureFrameClass({ open })}>
        ...
        >
          ...
          <div className={agentPanelDisclosureContentClass({ open })}>
            <span className={cn(agentPanelDisclosureLabelClass(), props.labelClassName)}>{props.label}</span>
            {summary ? <span className={cn(agentPanelDisclosureSummaryClass({ open }), props.summaryClassName)}>{summary}</span> : null}
          </div>
        ...
        <Collapsible.Panel className={agentPanelDisclosurePanelClass()} data-testid={props.panelTestId}>
          <ScrollArea.Root className="relative overflow-hidden">
            <ScrollArea.Viewport className={agentPanelDisclosureViewportClass()} data-testid={viewportTestId}>
