...
export const TOOLBAR_ROW_CLASS =
  "mx-0 flex min-h-[40px] items-center gap-0 overflow-x-auto px-3 py-1.5 text-[12px] text-[var(--wb-text)]";
export const TOOLBAR_GROUP_CLASS = "flex flex-none items-center gap-1";
export const TOOLBAR_SEPARATOR_CLASS = "mx-2 h-5 w-px shrink-0 bg-[var(--wb-border)]";
...
export const TOOLBAR_POPUP_CLASS =
  "overflow-hidden rounded-[var(--wb-radius-panel)] border border-[var(--wb-border-strong)] bg-[var(--wb-surface)] p-2 shadow-[var(--wb-shadow-md)]";
export const TOOLBAR_BORDER_POPUP_CLASS =
  "overflow-hidden rounded-[var(--wb-radius-panel)] border border-[var(--wb-border-strong)] bg-[var(--wb-surface)] px-2 py-1.5 shadow-[var(--wb-shadow-md)]";
...
export const COLOR_PICKER_POPUP_CLASS =
  "overflow-hidden rounded-[var(--wb-radius-panel)] border border-[var(--wb-border-strong)] bg-[var(--wb-surface)] p-3 shadow-[var(--wb-shadow-lg)]";
