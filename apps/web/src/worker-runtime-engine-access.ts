...
export function installAuthoritativeEngineState(
  ...
  snapshotCaches.installAuthoritativeState(
...
export async function resolveAuthoritativeStateInput(args: {
  ...
  return args.snapshotCaches.resolveAuthoritativeState({
    exportSnapshot: args.authoritativeEngine
      ? () => args.authoritativeEngine!.exportSnapshot()
      : null,
    exportReplica: args.authoritativeEngine
      ? () => args.authoritativeEngine!.exportReplicaSnapshot()
      : null,
  });
}
