...
describe('workbook shortcut dialog', () => {
  ...
  it('formats shortcut labels per platform', () => {
    ...
    expect(getWorkbookShortcutLabel('delete-selected-structure', 'MacIntel')).toBe('⌘⌥-')
    expect(getWorkbookShortcutLabel('delete-selected-structure', 'Win32')).toBe('Ctrl+Alt+-')
  ...
  it('splits shortcuts into readable keycap parts', () => {
    ...
    expect(getWorkbookShortcutParts('delete-selected-structure', 'MacIntel')).toEqual(['⌘', '⌥', '-'])
    ...
    expect(getWorkbookShortcutParts('delete-selected-structure', 'Win32')).toEqual(['Ctrl', 'Alt', '-'])
  })
})
