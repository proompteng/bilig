...
export function getWorkbookShortcutLabel(
  id: string,
...
export function groupWorkbookShortcutEntries(
  entries: readonly WorkbookShortcutEntry[],
): readonly {
  readonly category: WorkbookShortcutEntry["category"];
  readonly entries: readonly WorkbookShortcutEntry[];
}[] {
  const order: readonly WorkbookShortcutEntry["category"][] = [
    "Editing",
    "Formatting",
    "Navigation",
    "Selection",
