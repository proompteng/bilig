...
export function createWorkbookAgentDeveloperInstructions(): string {
  return [
    ...
    "Range and cell reads expose formatting metadata, including fill/background, font, alignment, borders, number format, and intersecting data validation rules when present.",
