...
export function createWorkbookAgentDeveloperInstructions(): string {
  return [
    ...
    "Range and cell reads expose formatting metadata, including fill/background, font, alignment, borders, number format, intersecting data validation rules, and cell comments or notes when present.",
