...
export interface LocalAgentEventQueueContext<
  SessionState extends LocalAgentEventQueueSessionState = LocalAgentEventQueueSessionState,
> {
...
export function removeQueuedSubscriptionEvents<
  SessionState extends LocalAgentEventQueueSessionState,
>(session: SessionState, subscriptionId: string): void {
